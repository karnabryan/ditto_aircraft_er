...
df_agg_right["left_len"] = df_agg_right["left"].apply(len)
...
df_agg_max_conf_right = (
      df_all[df_all["match"]==1].groupby('right_id', as_index=False)
...
df_all_merged_right["best"] = ((df_all_merged["match"]==1) & (df_all_merged["match_confidence"] == df_all_merged["match_confidence_max"])).astype(int)

# %%
df_all_merged_right[df_all_merged_right["best"] == 1]["right_id"].value_counts()

# %%
df_all_merged_right["right_id"].value_counts()
...
# %%
df_all_merged[df_all_merged["best"] == 1]["left_id"].value_counts()

# %%
df_all_merged["left_id"].value_counts()
